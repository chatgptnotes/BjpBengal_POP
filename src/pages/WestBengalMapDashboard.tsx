...
const WestBengalMapDashboard: React.FC = () => {
    ...
    try {
      if (includeGeoData && format === 'json') {
        ...
        const enrichedGeoJSON = {
          ...westBengalGeoJSON,
          features: (westBengalGeoJSON as any).features.map((feature: any) => {
        ...
        const constituencyList = (westBengalGeoJSON as any).features.map((feature: any, index: number) => {
          const constituencyName = feature.properties.AC_NAME;
          const sentiment = sentimentData[constituencyName as keyof typeof sentimentData];
      ...
      alert(`✅ Successfully exported ${(westBengalGeoJSON as any).features.length} constituencies as ${format.toUpperCase()}`);
    } catch (error) {
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <div className="mb-4">
                <h3 className="text-xl font-semibold text-gray-900 mb-2 flex items-center space-x-2">
                  ...
                  <span>Interactive West Bengal Constituencies Map</span>
                </h3>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <div className="mb-4">
                <h3 className="text-xl font-semibold text-gray-900 mb-2 flex items-center space-x-2">
                  ...
                  <span>2021 West Bengal Legislative Assembly Election Map</span>
                </h3>
                <p className="text-sm text-gray-600 mb-3">
                  Official election results map from the Election Commission of India showing all 294 constituencies
                </p>
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 text-xs text-blue-800">
                  <InfoIcon className="w-4 h-4 inline mr-1" />
                  This official map shows accurate constituency boundaries with 2021 election results for all 294 West Bengal constituencies.
                </div>
              </div>
                ...
                {!imageLoadError ? (
                  ...
                  <div className="flex flex-col items-center justify-center min-h-[500px] p-8 text-center">
                    ...
                    <p className="text-gray-600 mb-6 max-w-2xl">
                      The official 2021 West Bengal Legislative Assembly Election Map is not yet available in this installation.
                    </p>
                    <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-6 max-w-2xl text-left">
                      ...
                      <ol className="list-decimal list-inside space-y-2 text-sm text-blue-800">
                        <li>
                          Visit{' '}
                          <a
                            href="https://commons.wikimedia.org/wiki/File:2021_West_Bengal_Legislative_Assembly_election_map_by_parties.svg"
                            target="_blank"
            ...
            <div className="p-6">
              <div className="mb-6">
                <p className="text-gray-600 mb-2">
                  Export all 294 West Bengal constituency data with sentiment analysis.
                </p>
              ...
              <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                <p className="text-xs text-gray-600">
                  <strong>Note:</strong> All exports include data for all 294 West Bengal assembly constituencies.
...
export default WestBengalMapDashboard;
