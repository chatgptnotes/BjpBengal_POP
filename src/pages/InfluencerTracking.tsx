...
const mockInfluencerPosts: InfluencerPost[] = [
  {
    ...
    platform: 'Twitter/X',
    content: 'West Bengal Budget 2026 prioritizes sustainable development while ensuring social justice. Our commitment to education and healthcare remains unwavering. Together, we build a better tomorrow. #West BengalBudget2026 #Development',
    ...
    mentions: ['West Bengal Government', 'Citizens'],
    hashtags: ['#West BengalBudget2026', '#Development'],
    mediaType: 'text',
    isViral: true,
    influence: 92,
  ...
  },
  {
    ...
    platform: 'Instagram',
    content: 'Young voices matter in shaping our future! Excited to see more youth engagement in important discussions about our state\'s progress. Every opinion counts! ✨ #YouthVoice #West Bengal',
    ...
    mentions: ['Young People', 'West Bengal'],
    hashtags: ['#YouthVoice', '#West Bengal'],
    mediaType: 'video',
    isViral: true,
    influence: 88,
