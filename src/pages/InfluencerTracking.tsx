...
const influencers: Influencer[] = [
  {
    ...
    reachEstimate: 15000000,
    postsPerWeek: 15,
    avgShares: 45000,
    topTopics: ['Bengal Elections', 'TMC', 'State Governance', 'Anti-BJP'],
    politicalLean: 'left',
    credibilityScore: 85,
    isActive: true,
  ...
  },
  {
    ...
    postsPerWeek: 20,
    avgShares: 18000,
    topTopics: ['BJP Bengal', 'Nandigram', 'Anti-TMC', 'Bengal Elections'],
    politicalLean: 'right',
    credibilityScore: 78,
    isActive: true,
  ...
  },
  {
    ...
    reachEstimate: 7000000,
    postsPerWeek: 5,
    avgShares: 35000,
    topTopics: ['BJP Bengal', 'Entertainment', 'Bengal Culture', 'Elections'],
    politicalLean: 'right',
    credibilityScore: 75,
    isActive: true,
  ...
  },
  {
    ...
    postsPerWeek: 25,
    avgShares: 28000,
    topTopics: ['Bengal Elections', 'BJP', 'National Politics', 'Debates'],
    politicalLean: 'right',
    credibilityScore: 65,
    isActive: true,
  ...
  },
  {
    ...
    reachEstimate: 4500000,
    postsPerWeek: 12,
    avgShares: 15000,
    topTopics: ['TMC', 'Youth Politics', 'Bengal Development', 'Anti-BJP'],
    politicalLean: 'left',
    credibilityScore: 72,
    isActive: true,
  ...
  },
  {
    ...
    postsPerWeek: 18,
    avgShares: 12000,
    topTopics: ['BJP Bengal', 'Hindutva', 'Bengal Elections', 'Anti-TMC'],
    politicalLean: 'right',
    credibilityScore: 70,
    isActive: true,
  ...
  },
  {
    ...
    postsPerWeek: 8,
    avgShares: 22000,
    topTopics: ['Bengali Cinema', 'TMC', 'Bengal Culture', 'Youth Issues'],
    politicalLean: 'left',
    credibilityScore: 78,
    isActive: true,
  ...
  },
  {
    ...
    postsPerWeek: 30,
    avgShares: 18000,
    topTopics: ['RTI Activism', 'Anti-BJP', 'Government Accountability', 'Bengal Politics'],
    politicalLean: 'left',
    credibilityScore: 82,
    isActive: true,
    lastActive: new Date(Date.now() - 2400000),
    viralPosts: 52,
    mentions: 120000,
    collaboration: 'low',
    riskLevel: 'high'
...
const mockInfluencerPosts: InfluencerPost[] = [
  {
    id: '1',
    influencerId: '1',
    influencerName: 'Mamata Banerjee',
    platform: 'Twitter/X',
    content: 'Bengal will never bow down to divisive politics! Our state stands united for development, harmony, and progress. TMC is committed to protecting the rights of every citizen. #BengalFirst #TMC',
    ...
    sentiment: 'positive',
    sentimentScore: 0.72,
    topics: ['Bengal Elections', 'TMC', 'Unity', 'Development'],
    mentions: ['West Bengal', 'Citizens'],
    hashtags: ['#BengalFirst', '#TMC'],
    mediaType: 'text',
    isViral: true,
    influence: 95,
  ...
  },
  {
    id: '2',
    influencerId: '2',
    influencerName: 'Suvendu Adhikari',
    platform: 'Twitter/X',
    content: 'The people of Bengal deserve better governance! BJP will bring development and end corruption. Nandigram showed the way, now entire Bengal will follow. #BJPBengal #ChangeIsComing',
    ...
    sentiment: 'positive',
    sentimentScore: 0.68,
    topics: ['BJP', 'Bengal Elections', 'Development', 'Nandigram'],
    mentions: ['BJP Bengal', 'Voters'],
    hashtags: ['#BJPBengal', '#ChangeIsComing'],
    mediaType: 'video',
    isViral: true,
    influence: 88,
    politicalContent: true,
...
const trendingInfluencers: TrendingInfluencer[] = [
  {
    ...
    name: 'Suvendu Adhikari',
    growthRate: 18.5,
    reasonForTrending: 'Bengal election campaign rallies',
    timeframe: '24h',
    newFollowers: 65000,
    viralContent: 'Nandigram victory speech',
    impactScore: 88
  },
  {
    id: '2',
    name: 'Arnab Goswami',
    growthRate: 14.2,
    reasonForTrending: 'Bengal election debates coverage',
    timeframe: '7d',
    newFollowers: 42000,
    viralContent: 'Bengal political analysis',
    impactScore: 82
  }
];
