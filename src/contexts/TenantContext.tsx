    ...
    try {
      ...
      if (!isMultiTenantMode()) {
        ...
        const config: TenantConfig = {
          ...
          supabaseUrl: import.meta.env.VITE_SUPABASE_URL || 'https://mmmvpotyplosbsodnxwn.supabase.co',
          supabaseAnonKey: import.meta.env.VITE_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1tbXZwb3R5cGxvc2Jzb2RueHduIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjM5NjI5NjksImV4cCI6MjA3OTUzODk2OX0.DLWA5p-9jcl1q2yaQIuIeqJ7Ys1dDBg0I0YqfLV8Bcs',
